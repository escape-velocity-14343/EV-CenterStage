...
// robot dimensions: 17.25x15.625


@Config
@Autonomous
public class RelocalizationTest extends AutonBase {
    public static double camyoffset = -5.3;
    public static double camxoffset = 0.5;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Ultrasonic reading", backdist.getDistance()/2.54);
            telemetryAprilTag();
            update();
            atagRelocalize(getHeading());
            /*Pose2d atagpose = new Pose2d();
            int i = 0;
            double totalX = 0;
            double totalY = 0;
            for (AprilTagDetection detection : aprilTag.getDetections()) {

                atagpose = getFCPosition(detection, getHeading());
                totalX += atagpose.getX();
                totalY +=atagpose.getY();
                i++;
            }
            if (aprilTag.getDetections().size() > 0) {
                odometry.reset(totalX/i, totalY/i);
            }*/
            telemetry.update();
